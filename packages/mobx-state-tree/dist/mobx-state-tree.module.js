...
function createFlowSpawner(name, generator) {
    var spawner = function flowSpawner() {
        ...
        function onFulfilled(res) {
            ...
            try {
                // prettier-ignore
                wrap(function (r) { ret = thisFlowGenerator.next(r); }, "flow_resume", res);
            } catch (e) {
                // prettier-ignore
                setImmediateWithFallback(function () {
                    wrap(function (r) { rejector(e); }, "flow_throw", e);
                });
                return
            }
        ...
        function onRejected(err) {
            ...
            try {
                // prettier-ignore
                wrap(function (r) { ret = thisFlowGenerator.throw(r); }, "flow_resume_error", err); // or yieldError?
            } catch (e) {
                // prettier-ignore
                setImmediateWithFallback(function () {
                    wrap(function (r) { rejector(e); }, "flow_throw", e);
         ...
         */
        function handleThisFlowGeneratorNextValue(ret) {
            if (ret.done) {
                // prettier-ignore
                setImmediateWithFallback(function () {
                    wrap(function (r) { resolver(r); }, "flow_return", ret.value);
                });
                return
            }
