                    ...
                    return (
                        ...
                        this.parent
                            ? (void 0 === this._escapedSubpath &&
                                  (this._escapedSubpath = this._subpath ? He(this._subpath) : ""),
    ...
    x = (function (r) {
        function n(e, n, i, a, o) {
            ...
            if (
                ...
                ;(u.identifier = Mt(l)), (u.unnormalizedIdentifier = l)
            }
            return (
                ...
                return (
                    ...
                    (e.snapshot === t ||
                        ...
                        (!(
                            ...
                            !xe(t) ||
                            ce(t) ||
                            (e.identifierAttribute && e.identifier !== Mt(t[e.identifierAttribute]))
                        ) &&
                            (e.applySnapshot(t), !0)))
                )
            }
    ...
    t.runInAction(function () {
        Ie(r).forEach(function (t) {
            return (function (e, t) {
                ...
                if ("@APPLY_SNAPSHOT" === t.name) return h.call(null, r, t.args[0])
...
function he(e, t) {
    ...
    return r.slice(i).map(de).join("/") + Ue(n.slice(i))
}
function ye(e, t, r) {
    return void 0 === r && (r = !0), ve(e, $e(t), r)
}
function ve(e, t, r) {
    void 0 === r && (r = !0)
        ...
        var r = function () {
            ...
            var m = new Promise(function (e, i) {
                ...
                ;(a.$mst_middleware = r.$mst_middleware),
                    W(u(u({}, b), { type: "flow_spawn", args: De(d) }), a)
            })
            return (
                (m.cancel = function () {
...
var We = (function (e) {
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "isValidSnapshot", {
            ...
            writable: !0,
            value: function (e, t) {
                var r = this.preProcessSnapshot(e)
                return this._subtype.validate(r, t)
            }
        }),
        Object.defineProperty(t.prototype, "getSubTypes", {
            enumerable: !1,
        ...
        Object.defineProperty(t.prototype, "is", {
            ...
            writable: !0,
            value: function (e) {
                var t = D(e) ? this._subtype : ce(e) ? y(e, !1) : this.preProcessSnapshot(e)
                return 0 === this._subtype.validate(t, [{ path: "", type: this._subtype }]).length
            }
        }),
        ...
        return (
            ...
            Object.defineProperty(r.prototype, "put", {
                ...
                value: function (e) {
                    ...
                    if (ce(e)) {
                        var t = pe(e)
                        if (null === t.identifier) throw je(Ye)
                        return this.set(t.identifier, e), e
                    }
                    if (xe(e)) {
                        var r = pe(this),
                            n = r.type
                        if (n.identifierMode !== Ge.YES) throw je(Ye)
                ...
                value: function (e) {
                    ...
                    switch (e.type) {
                        ...
                        case "delete":
                            ...
                            return (
                                e.oldValue.die(),
                                void t.emitPatch({ op: "remove", path: He(e.name), oldValue: r }, t)
                            )
                    }
                }
            }),
...
var et = { name: "AnonymousModel", properties: {}, initializers: we }
function tt(t) {
...
var vt = (function (e) {
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "reconcile", {
            ...
            writable: !0,
            value: function (e, t, r, n) {
                var i = this.determineType(t, e.type)
                if (!i) throw je("No matching type for union " + this.describe())
                        ...
                        a &&
                            this.onInvalidated({
                                ...
                                replaceRef: function (e) {
                                    d(t.root.storedValue, { op: "replace", value: e, path: t.path })
                                },
                                removeRef: function () {
                                    nt(i.type)
                        ...
                        var o = function (e) {
                            ...
                            if (o && o.isAlive && u) {
                                ;(
                                    n
                                        ? !!n.get(r, u)
                                        : t.root.identifierCache.has(i.targetType, Mt(r))
                                )
...
;(exports.addDisposer = function (e, t) {
    ...
    (exports.applyAction = F),
    (exports.applyPatch = d),
    (exports.applySnapshot = h),
    ...
    (exports.resolveIdentifier = function (e, t, r) {
        var n = pe(t).root.identifierCache.resolve(e, Mt(r))
