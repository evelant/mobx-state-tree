...
function b(e, t) {
    return pe(e).onPatch(t)
}
function h(e, t) {
    pe(e).applyPatches(Ie(t))
}
function d(e, t) {
    return pe(e).applySnapshot(t)
}
function y(e, t) {
    void 0 === t && (t = !0)
    var r = pe(e)
...
function v(e) {
    return pe(e).root.storedValue
}
function g(e) {
    return pe(e).path
}
function m(e) {
    return pe(e).identifier
}
function w(e, t) {
    var r = ye(pe(e), t, !1)
    if (void 0 !== r)
...
function P(e) {
    return pe(e).observableIsAlive
}
function O(e) {
    var t
    return { name: (t = ce(e) ? f(e) : e).name, properties: u({}, t.properties) }
}
var j = (function () {
        function r(e, t, r, n) {
        ...
        return (
                    ...
                    return (
                        ...
                        this.parent
                            ? (void 0 === this._escapedSubpath &&
                                  (this._escapedSubpath = this._subpath ? Le(this._subpath) : ""),
            ...
            Object.defineProperty(r.prototype, "isDetaching", {
                get: function () {
                    return this.state === ae.DETACHING
                },
                enumerable: !1,
                configurable: !0
            }),
            ...
            Object.defineProperty(r.prototype, "baseFinalizeCreation", {
                ...
                writable: !0,
                value: function (t) {
                    if (this.state === ae.CREATED) {
                        if (this.parent) {
                            if (this.parent.state !== ae.FINALIZED) return
                            this.fireHook(e.afterAttach)
                        }
                        ;(this.state = ae.FINALIZED), t && t()
                    }
                }
            }),
    ...
    _ = (function (e) {
        function t(t, r, n, i, a) {
            ...
            try {
                ...
                throw ((o.state = ae.DEAD), e)
            }
            return (o.state = ae.CREATED), o.finalizeCreation(), o
        }
        return (
            o(t, e),
            Object.defineProperty(t.prototype, "root", {
                get: function () {
                    if (!this.parent) throw je("This scalar node is not part of a tree")
    ...
    x = (function (r) {
        function n(e, n, i, a, o) {
            ...
            if (
                ...
                ;(u.identifier = Lt(l)), (u.unnormalizedIdentifier = l)
            }
            return (
        ...
        return (
            ...
            Object.defineProperty(n.prototype, "getChildren", {
                ...
                writable: !0,
                value: function () {
                    this.assertAlive(Pe), (this._autoUnbox = !1)
                    try {
                        return 2 === this._observableInstanceState
            ...
            Object.defineProperty(n.prototype, "detach", {
                ...
                writable: !0,
                value: function () {
                    if (!this.isAlive) throw je("Error while detaching, node is not alive.")
                    this.clearParent()
                }
            }),
                ...
                value: function () {
                    ...
                    ;(this._applyPatches = Y(this.storedValue, "@APPLY_PATCHES", function (t) {
                        t.forEach(function (t) {
                            if (t.path) {
                                var r = We(t.path)
                                ve(e, r.slice(0, -1)).applyPatchLocally(r[r.length - 1], t)
    ...
    E = (function () {
        ...
        return (
            Object.defineProperty(e.prototype, "create", {
                ...
                writable: !0,
                value: function (e, t) {
                    return ne(this, e), this.instantiate(null, "", t, e).value
                }
            }),
...
var V = (function (e) {
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "isMatchingSnapshotId", {
            ...
            writable: !0,
            value: function (e, t) {
                return !e.identifierAttribute || e.identifier === Lt(t[e.identifierAttribute])
            }
        }),
        ...
        Object.defineProperty(t.prototype, "reconcile", {
            ...
            value: function (e, t, r, n) {
                ...
                if ((e.die(), ce(t) && this.isAssignableFrom(f(t)))) {
                    var i = pe(t)
        ...
        Ie(r).forEach(function (t) {
            return (function (e, t) {
                ...
                if ("function" != typeof r[t.name])
                    throw je("Action '" + t.name + "' does not exist in '" + n.path + "'")
                    ...
                    o = {
                        ...
                        args: n.args.map(function (e, t) {
                            return (function (e, t, r, n) {
                                ...
                                if (Ce(n)) return n
                                if (ce(n)) return z("[MSTNode: " + f(n).name + "]")
                                if ("function" == typeof n) return z("[function]")
                                if ("object" == typeof n && !Te(n) && !Ae(n))
                                    return z(
                                        "[object " +
...
function J(e, t, r) {
    return void 0 === r && (r = !0), pe(e).addMiddleWare(t, r)
}
var Z = (function () {
    function e(e, t) {
...
function Q(e) {
    var t = e.value,
        ...
        a = ce(t) ? "value of type " + pe(t).type.name + ":" : Ce(t) ? "value" : "snapshot",
        o = r && ce(t) && r.is(pe(t).snapshot)
    return (
        "" +
        i +
        a +
...
function ne(e, t) {
    "undefined" != typeof process &&
        process.env &&
        "true" === process.env.ENABLE_TYPE_CHECK &&
        ie(e, t)
}
function ie(e, t) {
        ...
        throw je(
            (function (e, t, r) {
                ...
                return (
                    ...
                    (n.length < 280
                        ? n
                        : n.substring(0, 272) + "......" + n.substring(n.length - 8)) + " to `") +
                    e.name +
                    "`:\n\n    " +
                    r.map(Q).join("\n    ")
                )
            ...
            Object.defineProperty(e.prototype, "addNodeToCache", {
                ...
                value: function (e, r) {
                    if ((void 0 === r && (r = !0), e.identifierAttribute)) {
                        var n = e.identifier
                        this.cache.has(n) || this.cache.set(n, t.observable.array([], Oe))
                        var i = this.cache.get(n)
                        if (-1 !== i.indexOf(e)) throw je("Already registered")
...
function pe(e) {
    if (!ce(e)) throw je("Value " + e + " is no MST Node")
    return e.$treenode
}
function fe(e) {
...
function de(e, t) {
    ...
    for (var r = We(e.path), n = We(t.path), i = 0; i < r.length && r[i] === n[i]; i++);
    return r.slice(i).map(he).join("/") + $e(n.slice(i))
}
function ye(e, t, r) {
    return void 0 === r && (r = !0), ve(e, We(t), r)
}
function ve(e, t, r) {
    void 0 === r && (r = !0)
...
var me = Object.toString(),
    we = Object.freeze([]),
    Pe = Object.freeze({}),
    Oe = t._getGlobalState().useProxies ? { deep: !1 } : { deep: !1, proxy: !1 }
function je(e) {
...
function Te(e) {
    ...
    return (
        null == r || (null === (t = r.constructor) || void 0 === t ? void 0 : t.toString()) === me
    )
}
function xe(e) {
...
function Me(e) {
    return (function (e, t) {
        var r = function () {
            ...
            var a = $(),
                o = U()
            if (!o) throw je("a mst flow must always have a parent context")
            var l = G(o)
            if (!l) throw je("a mst flow must always have a parent action context")
            var s,
                c,
                f,
                b = {
                    ...
                    context: o.context,
                    parentId: o.id,
                    allParentIds: p(o.allParentIds, [o.id]),
                    rootId: o.rootId,
                    parentEvent: o,
                    parentActionEvent: l
                },
                h = arguments
            function d(e, t, n) {
                ;(e.$mst_middleware = r.$mst_middleware), W(u(u({}, b), { type: t, args: [n] }), e)
            }
            function y(e) {
                var t
                try {
            ...
            function g(e) {
                if (!e.done) {
                    if (!e.value || "function" != typeof e.value.then)
                        throw je("Only promises can be yielded to `async`, got: " + e)
                    return e.value.then(y, v)
                }
                ze(function () {
                    d(
                        function (e) {
            ...
            var m = new Promise(function (e, i) {
                ;(c = e), (f = i)
                var a = function () {
                    ;(s = t.apply(null, n)), y(void 0)
                }
                ;(a.$mst_middleware = r.$mst_middleware),
                    W(u(u({}, b), { type: "flow_spawn", args: De(h) }), a)
            })
            return (
                (m.cancel = function () {
                    s.next(v(new Error("FLOW_CANCELLED")))
                }),
                m
            )
        }
...
function We(e) {
    var t = e.split("/").map(Ue)
    if (!("" === e || "." === e || ".." === e || ke(e, "/") || ke(e, "./") || ke(e, "../")))
        throw je("a json path must be either rooted, empty or relative, but got '" + e + "'")
    return "" === t[0] && t.shift(), t
}
Re.ids = {}
var Ge = Symbol("$preProcessorFailed"),
    Ye = (function (e) {
        function t(t, r, n) {
        ...
        return (
            ...
            Object.defineProperty(t.prototype, "_fixNode", {
                ...
                value: function (e) {
                    ...
                    })(e.type, this, "create", "is", "isMatchingSnapshotId")
                    var r = e.getSnapshot
            ...
            Object.defineProperty(t.prototype, "instantiate", {
                ...
                writable: !0,
                value: function (e, t, r, n) {
                    var i = ce(n) ? n : this.preProcessSnapshot(n),
            ...
            Object.defineProperty(t.prototype, "reconcile", {
                ...
                writable: !0,
                value: function (e, t, r, n) {
                    var i = this._subtype.reconcile(e, ce(t) ? t : this.preProcessSnapshot(t), r, n)
            ...
            Object.defineProperty(t.prototype, "is", {
                ...
                writable: !0,
                value: function (e) {
                    var t = D(e) ? this._subtype : ce(e) ? y(e, !1) : this.preProcessSnapshotSafe(e)
                    return (
                        t !== Ge &&
            ...
            Object.defineProperty(t.prototype, "isMatchingSnapshotId", {
                ...
                value: function (e, t) {
                    ...
                    return V.prototype.isMatchingSnapshotId.call(this._subtype, e, r)
                }
            }),
            t
        )
...
var Je,
    Ze = "Map.put can only be used to store complex values that have an identifier type attribute"
!(function (e) {
...
var Be = (function (e) {
        ...
        return (
            ...
            Object.defineProperty(r.prototype, "put", {
                ...
                writable: !0,
                value: function (e) {
                    if (!e) throw je("Map.put cannot be used to set empty values")
                    if (ce(e)) {
                        var t = pe(e)
                        if (null === t.identifier) throw je(Ze)
                        return this.set(t.identifier, e), e
                    }
                    if (xe(e)) {
                        var r = pe(this),
                            n = r.type
                        if (n.identifierMode !== Je.YES) throw je(Ze)
                    ...
                    throw je("Map.put can only be used to store complex values")
                }
            }),
            r
        )
    ...
    Ke = (function (e) {
        ...
        return (
            ...
            Object.defineProperty(r.prototype, "instantiate", {
                ...
                writable: !0,
                value: function (e, t, r, n) {
                    return this._determineIdentifierMode(), le(this, e, t, r, n)
                }
            }),
            Object.defineProperty(r.prototype, "_determineIdentifierMode", {
                ...
                writable: !0,
                value: function () {
                    if (this.identifierMode === Je.UNKNOWN) {
                        var e = []
                        if (
                            (function e(t, r) {
                                var n,
                                ...
                                return t instanceof it && r.push(t), !0
                            })(this._subType, e)
                        ) {
                            var t = void 0
                            e.forEach(function (e) {
                                ...
                                t
                                    ? ((this.identifierMode = Je.YES),
                                      (this.mapIdentifierAttribute = t))
                                    : (this.identifierMode = Je.NO)
                        }
                    }
                }
            }),
            ...
            Object.defineProperty(r.prototype, "processIdentifier", {
                ...
                writable: !0,
                value: function (e, t) {
                    if (this.identifierMode === Je.YES && t instanceof x) {
                        var r = t.identifier
                        if (r !== e)
                            throw je(
                ...
                value: function (e) {
                    ...
                    switch (e.type) {
                        ...
                        case "delete":
                            ...
                            return (
                                e.oldValue.die(),
                                void t.emitPatch({ op: "remove", path: Le(e.name), oldValue: r }, t)
                            )
                    }
                }
            }),
...
var qe = (function (e) {
    ...
    return (
        ...
        Object.defineProperty(r.prototype, "createNewInstance", {
            ...
            writable: !0,
            value: function (e) {
                return t.observable.array(ge(e), Oe)
            }
        }),
        Object.defineProperty(r.prototype, "finalizeNewInstance", {
            enumerable: !1,
        ...
        Object.defineProperty(r.prototype, "applySnapshot", {
            ...
            writable: !0,
            value: function (e, t) {
                ne(this, t), e.storedValue.replace(t)
            }
        }),
        Object.defineProperty(r.prototype, "getChildType", {
            enumerable: !1,
...
function Xe(e, t, r, n, i) {
    ...
    var a = (function () {
        if (ce(n)) {
            var a = pe(n)
            if ((a.assertAlive(Pe), null !== a.parent && a.parent === t))
...
function et(e, t) {
    ...
    return (
        ...
        (e instanceof x &&
            ...
            Te(t) &&
            e.type.is(t) &&
            e.type.isMatchingSnapshotId(e, t))
    )
}
qe.prototype.applySnapshot = t.action(qe.prototype.applySnapshot)
function tt() {
    return pe(this).toString()
}
var rt = { name: "AnonymousModel", properties: {}, initializers: we }
function nt(t) {
    return Object.keys(t).reduce(function (t, r) {
        ...
        if ("get" in o)
            throw je("Getters are not supported as properties. Please use views instead")
        var u = o.value
        if (null == u)
            throw je(
                    ...
                    (function (e) {
                        switch (typeof e) {
                            ...
                            case "boolean":
                                return ct
                            case "object":
                                if (e instanceof Date) return ht
                        }
                        throw je("Cannot determine primitive type from value " + e)
                    })(u),
                    u
                )),
                n)
            )
        if (u instanceof Ke) return Object.assign({}, t, (((i = {})[r] = Ot(u, {})), i))
        if (u instanceof qe) return Object.assign({}, t, (((a = {})[r] = Ot(u, [])), a))
        if (D(u)) return t
        throw je(
...
var it = (function (r) {
    function n(e) {
        var t = r.call(this, e.name || rt.name) || this
        return (
    ...
    return (
        ...
        Object.defineProperty(n.prototype, "instantiateActions", {
            ...
            value: function (t, r) {
                if (!Te(r))
                    throw je("actions initializer should return a plain object containing actions")
        ...
        Object.defineProperty(n.prototype, "instantiateViews", {
            ...
            value: function (e, r) {
                if (!Te(r))
                    throw je("views initializer should return a plain object containing views")
                Object.keys(r).forEach(function (n) {
                    var i,
        ...
        Object.defineProperty(n.prototype, "instantiate", {
            ...
            writable: !0,
            value: function (e, t, r, n) {
                return le(this, e, t, r, ce(n) ? n : this.applySnapshotPreProcessor(n))
            }
        }),
        ...
        Object.defineProperty(n.prototype, "createNewInstance", {
            ...
            writable: !0,
            value: function (e) {
                return t.observable.object(e, Pe, Oe)
            }
        }),
        ...
        Object.defineProperty(n.prototype, "getChildNode", {
            ...
            writable: !0,
            value: function (e, r) {
                if (!(r in this.properties)) throw je("Not a value property: " + r)
                var n = t._getAdministration(e.storedValue, r).raw()
                if (!n) throw je("Node not available for property " + r)
                return n
            }
        }),
        Object.defineProperty(n.prototype, "getSnapshot", {
        ...
        Object.defineProperty(n.prototype, "applyPatchLocally", {
            ...
            value: function (e, t, r) {
                if ("replace" !== r.op && "add" !== r.op)
                    throw je("object does not support operation " + r.op)
...
it.prototype.applySnapshot = t.action(it.prototype.applySnapshot)
var ot = (function (e) {
        function t(t, r, n, i) {
            void 0 === i && (i = _e)
    ...
    ut = new ot("string", A.String, function (e) {
        return "string" == typeof e
    }),
    lt = new ot("number", A.Number, function (e) {
        return "number" == typeof e
    }),
    st = new ot("integer", A.Integer, function (e) {
        return Se(e)
    }),
    ct = new ot("boolean", A.Boolean, function (e) {
        return "boolean" == typeof e
    }),
    pt = new ot("null", A.Null, function (e) {
        return null === e
    }),
    ft = new ot("undefined", A.Undefined, function (e) {
        return void 0 === e
    }),
    bt = new ot(
        "Date",
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "instantiate", {
            ...
            value: function (e, t, r, n) {
                ...
                if (!i) throw je("No matching type for union " + this.describe())
            ...
            value: function () {
                var e =
                    "function" == typeof this._defaultValue
                        ? this._defaultValue()
                        : this._defaultValue
                return "function" == typeof this._defaultValue && ne(this, e), e
            }
        }),
        Object.defineProperty(t.prototype, "isValidSnapshot", {
            enumerable: !1,
        ...
        function e(e, t) {
            if (
                ...
                if (!r.identifierAttribute)
                    throw je("Can only store references with a defined identifier attribute.")
                var n = r.unnormalizedIdentifier
                if (null == n)
                    throw je("Can only store references to tree nodes with a defined identifier.")
                this.identifier = n
            }
        }
        return (
    ...
    Dt = (function (e) {
        ...
        return (
            ...
            Object.defineProperty(t.prototype, "instantiate", {
                ...
                writable: !0,
                value: function (e, t, r, n) {
                    var i = ce(n) ? this.options.set(n, e ? e.storedValue : null) : n,
                        a = se(this, e, t, r, i)
            ...
            Object.defineProperty(t.prototype, "reconcile", {
                ...
                writable: !0,
                value: function (e, t, r, n) {
                    var i = ce(t) ? this.options.set(t, e ? e.storedValue : null) : t
    ...
    Wt = {
        ...
        model: function () {
            ...
            var r = "string" == typeof e[0] ? e.shift() : "AnonymousModel",
                n = e.shift() || {}
            return new it({ name: r, properties: n })
        },
        compose: function () {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t]
        ...
        safeReference: function (e, t) {
            ...
            return t && !1 === t.acceptsUndefined ? r : At(r)
        },
        union: wt,
        optional: Ot,
        literal: vt,
        ...
        Date: ht,
        map: function (e) {
            return new Ke("map<string, " + e.name + ">", e)
        },
        array: function (e) {
            return new qe(e.name + "[]", e)
        },
        frozen: function (e) {
            return 0 === arguments.length ? xt : D(e) ? new Tt(e) : Ot(xt, e)
        },
        identifier: Ft,
        identifierNumber: Ht,
        late: function (e, t) {
            var r = "string" == typeof e ? e : "late(" + e.toString() + ")"
            return new It(r, "string" == typeof e ? t : e)
        },
        undefined: ft,
        null: pt,
...
;(exports.addDisposer = function (e, t) {
    ...
    (exports.detach = function (e) {
        return pe(e).detach(), e
    }),
    (exports.escapeJsonPath = Le),
    (exports.flow = Me),
    (exports.getChildType = function (e, t) {
        return pe(e).getChildType(t)
    }),
    (exports.getEnv = function (e) {
        var t = pe(e).root.environment
        return t || Pe
    }),
    ...
    (exports.getParent = function (e, t) {
        void 0 === t && (t = 1)
        for (var r = t, n = pe(e).parent; n; ) {
            if (0 == --r) return n.storedValue
            n = n.parent
        }
        throw je("Failed to find the parent of " + pe(e) + " at depth " + t)
    }),
    (exports.getParentOfType = function (e, t) {
        for (var r = pe(e).parent; r; ) {
            if (t.is(r.storedValue)) return r.storedValue
            r = r.parent
        }
        throw je("Failed to find the parent of " + pe(e) + " of a given type")
    }),
    (exports.getPath = g),
    ...
    (exports.isValidReference = function (e, t) {
        ...
        try {
            var r = e()
            if (null == r) return !1
            if (ce(r)) return !t || P(r)
            throw je("The reference to be checked is not one of node, null or undefined")
        } catch (e) {
            if (e instanceof Et) return !1
            throw e
        }
    }),
    (exports.joinJsonPath = $e),
    (exports.onAction = F),
    (exports.onPatch = b),
    (exports.onSnapshot = function (e, t) {
        return pe(e).onSnapshot(t)
    }),
    ...
    (exports.protect = function (e) {
        var t = pe(e)
        if (!t.isRoot) throw je("`protect` can only be invoked on root nodes")
    ...
    (exports.resolveIdentifier = function (e, t, r) {
        var n = pe(t).root.identifierCache.resolve(e, Lt(r))
    ...
    (exports.tryReference = function (e, t) {
        ...
        try {
            var r = e()
            if (null == r) return
            if (ce(r)) return t ? (P(r) ? r : void 0) : r
            throw je("The reference to be checked is not one of node, null or undefined")
        } catch (e) {
    ...
    (exports.typecheck = ie),
    (exports.types = Wt),
    (exports.unescapeJsonPath = Ue),
    (exports.unprotect = function (e) {
        var t = pe(e)
        if (!t.isRoot) throw je("`unprotect` can only be invoked on root nodes")
        t.isProtectionEnabled = !1
    }),
    (exports.walk = function e(t, r) {
        var n = pe(t)
        n.getChildren().forEach(function (t) {
            ce(t.storedValue) && e(t.storedValue, r)
        }),
            r(n.storedValue)
    })
