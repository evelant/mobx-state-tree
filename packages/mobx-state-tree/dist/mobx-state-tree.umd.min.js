!(function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        : t(((e = e || self).mobxStateTree = {}), e.mobx)
})(this, function (e, t) {
    "use strict"
    var r,
        n = "warn"
    ...
    ***************************************************************************** */
    ...
    function j(e) {
        var t
        return { name: (t = fe(e) ? b(e) : e).name, properties: l({}, t.properties) }
    }
    var _ = (function () {
            function e(e, t, r, n) {
                ...
                Object.defineProperty(n.prototype, "preboot", {
                    ...
                    value: function () {
                        ...
                        ;(this._applyPatches = J(this.storedValue, "@APPLY_PATCHES", function (t) {
                            ...
                            (this._applySnapshot = J(this.storedValue, "@APPLY_SNAPSHOT", function (
                                t
                            ) {
        ...
        return (
                        ...
                        (e.snapshot === t ||
                            ...
                            (!(
                                ...
                                (e.identifierAttribute &&
                                    e.identifier !== Ht(t[e.identifierAttribute]))
                            ) &&
                                (e.applySnapshot(t), !0)))
                    )
                }
            ...
            Object.defineProperty(t.prototype, "reconcile", {
                ...
                value: function (e, t, r, n) {
                    ...
                    if ((e.die(), fe(t) && this.isAssignableFrom(b(t)))) {
                        var i = pe(t)
                        ...
                        o = {
                            ...
                            args: n.args.map(function (e, t) {
                                return (function (e, t, r, n) {
                                    ...
                                    if (Ve(n)) return n
                                    if (fe(n)) return F("[MSTNode: " + b(n).name + "]")
                                    if ("function" == typeof n) return F("[function]")
    ...
    function X(e) {
        var t = e.value,
            ...
            a = fe(t) ? "value of type " + pe(t).type.name + ":" : Ve(t) ? "value" : "snapshot",
            o = r && fe(t) && r.is(pe(t).snapshot)
        return (
            "" +
            i +
            a +
                    ...
                    value: function (r) {
                        ...
                        return (
                            t.entries(this.cache).forEach(function (e) {
                                for (
                                    var t = f(e, 2), r = t[0], o = t[1], u = !1, l = o.length - 1;
                                    l >= 0;
                                    l--
                                )
    ...
    function pe(e) {
        if (!fe(e)) throw _e("Value " + e + " is no MST Node")
        return e.$treenode
    }
    function be(e) {
    ...
    function ve(e, t, r) {
        return void 0 === r && (r = !0), ge(e, We(t), r)
    }
    function ge(e, t, r) {
        void 0 === r && (r = !0)
    ...
    var Ge = (function (e) {
        ...
        return (
            ...
            Object.defineProperty(t.prototype, "instantiate", {
                ...
                writable: !0,
                value: function (e, t, r, n) {
                    var i = fe(n) ? n : this.preProcessSnapshot(n),
            ...
            Object.defineProperty(t.prototype, "reconcile", {
                ...
                writable: !0,
                value: function (e, t, r, n) {
                    var i = this._subtype.reconcile(e, fe(t) ? t : this.preProcessSnapshot(t), r, n)
            ...
            Object.defineProperty(t.prototype, "is", {
                ...
                writable: !0,
                value: function (e) {
                    var t = k(e) ? this._subtype : fe(e) ? v(e, !1) : this.preProcessSnapshot(e)
                    return (
            ...
            return (
                ...
                Object.defineProperty(r.prototype, "put", {
                    ...
                    value: function (e) {
                        ...
                        if (fe(e)) {
                            var t = pe(e)
                            if (null === t.identifier) throw _e(Je)
                            return this.set(t.identifier, e), e
                        }
                        if (Ee(e)) {
                            var r = pe(this),
                                n = r.type
                            if (n.identifierMode !== Ye.YES) throw _e(Je)
                        ...
                        switch (e.type) {
                            ...
                            case "delete":
                                ...
                                return (
                                    e.oldValue.die(),
                                    void t.emitPatch(
                                        { op: "remove", path: Le(e.name), oldValue: r },
                                        t
                                    )
                                )
                        }
    ...
    function qe(e, t, r, n, i) {
        for (var a, o = !0, u = 0; ; u++) {
            ...
            if (l)
                if (s)
                    if (Xe(s, c)) r[u] = Qe(t, e, f, c, s)
                    else {
                        for (var p = void 0, b = u; b < r.length; b++)
                            if (Xe(r[b], c)) {
                                p = r.splice(b, 1)[0]
                                break
                            }
    ...
    var tt = { name: "AnonymousModel", properties: {}, initializers: Pe }
    function rt(e) {
    ...
    var nt = (function (e) {
        ...
        return (
            ...
            Object.defineProperty(n.prototype, "instantiate", {
                ...
                writable: !0,
                value: function (e, t, r, n) {
                    return se(this, e, t, r, fe(n) ? n : this.applySnapshotPreProcessor(n))
                }
            }),
    ...
    var at = (function (e) {
        ...
        ft = new at("undefined", I.Undefined, function (e) {
            return void 0 === e
        }),
        pt = new at(
            "Date",
        ...
        Dt = (function (e) {
            ...
            return (
                ...
                Object.defineProperty(t.prototype, "instantiate", {
                    ...
                    writable: !0,
                    value: function (e, t, r, n) {
                        var i = fe(n) ? this.options.set(n, e ? e.storedValue : null) : n,
                            a = ce(this, e, t, r, i)
                ...
                Object.defineProperty(t.prototype, "reconcile", {
                    ...
                    writable: !0,
                    value: function (e, t, r, n) {
                        var i = fe(t) ? this.options.set(t, e ? e.storedValue : null) : t
    ...
    ;(e.addDisposer = function (e, t) {
        ...
        (e.getParent = function (e, t) {
            ...
            throw _e("Failed to find the parent of " + pe(e) + " at depth " + t)
        }),
        (e.getParentOfType = function (e, t) {
            ...
            throw _e("Failed to find the parent of " + pe(e) + " of a given type")
        }),
        (e.getPath = m),
        ...
        (e.resolveIdentifier = function (e, t, r) {
            var n = pe(t).root.identifierCache.resolve(e, Ht(r))
        ...
        (e.tryReference = function (e, t) {
            ...
            try {
                var r = e()
                if (null == r) return
                if (fe(r)) return t ? (O(r) ? r : void 0) : r
                throw _e("The reference to be checked is not one of node, null or undefined")
            } catch (e) {
        ...
        (e.walk = function e(t, r) {
            ...
            n.getChildren().forEach(function (t) {
                fe(t.storedValue) && e(t.storedValue, r)
            }),
                r(n.storedValue)
        }),
