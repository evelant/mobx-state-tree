!(function (e, t) {
    ...
    ***************************************************************************** */
    ...
    function h(e, t) {
        return fe(e).onPatch(t)
    }
    function d(e, t) {
        fe(e).applyPatches(Te(t))
    }
    function y(e, t) {
        return fe(e).applySnapshot(t)
    }
    function v(e, t) {
        void 0 === t && (t = !0)
        var r = fe(e)
    ...
    function g(e) {
        return fe(e).root.storedValue
    }
    function m(e) {
        return fe(e).path
    }
    function w(e) {
        return fe(e).identifier
    }
    function P(e, t) {
        var r = ve(fe(e), t, !1)
        if (void 0 !== r)
    ...
    function O(e) {
        return fe(e).observableIsAlive
    }
    function j(e) {
        var t
        return { name: (t = pe(e) ? b(e) : e).name, properties: l({}, t.properties) }
    }
    var _ = (function () {
            function e(e, t, r, n) {
            ...
            return (
                ...
                Object.defineProperty(e.prototype, "registerHook", {
                    ...
                    value: function (e, t) {
                        return (
                            this._hookSubscribers || (this._hookSubscribers = new xe()),
                ...
                Object.defineProperty(e.prototype, "isDetaching", {
                    get: function () {
                        return this.state === oe.DETACHING
                    },
                    enumerable: !1,
                    configurable: !0
                }),
                ...
                Object.defineProperty(e.prototype, "baseFinalizeCreation", {
                    ...
                    writable: !0,
                    value: function (e) {
                        if (this.state === oe.CREATED) {
                            if (this.parent) {
                                if (this.parent.state !== oe.FINALIZED) return
                                this.fireHook(r.afterAttach)
                            }
                            ;(this.state = oe.FINALIZED), e && e()
                        }
                    }
                }),
        ...
        S = (function (e) {
            function t(t, r, n, i, a) {
                ...
                try {
                    ...
                    throw ((o.state = oe.DEAD), e)
                }
                return (o.state = oe.CREATED), o.finalizeCreation(), o
            }
            return (
                u(t, e),
                Object.defineProperty(t.prototype, "root", {
                    get: function () {
                        if (!this.parent) throw _e("This scalar node is not part of a tree")
        ...
        E = (function (e) {
            function n(r, n, i, a, o) {
                ...
                if (
                    ...
                    ;(u.identifier = Ut(l)), (u.unnormalizedIdentifier = l)
                }
                return (
                    n
            ...
            return (
                ...
                Object.defineProperty(n.prototype, "getChildren", {
                    ...
                    writable: !0,
                    value: function () {
                        this.assertAlive(Oe), (this._autoUnbox = !1)
                        try {
                            return 2 === this._observableInstanceState
                ...
                Object.defineProperty(n.prototype, "detach", {
                    ...
                    writable: !0,
                    value: function () {
                        if (!this.isAlive) throw _e("Error while detaching, node is not alive.")
                        this.clearParent()
                    }
                }),
                    ...
                    value: function () {
                        ...
                        ;(this._applyPatches = J(this.storedValue, "@APPLY_PATCHES", function (t) {
                            t.forEach(function (t) {
                                if (t.path) {
                                    var r = Ge(t.path)
                                    ge(e, r.slice(0, -1)).applyPatchLocally(r[r.length - 1], t)
                            ...
                            Ne(this.storedValue, "$treenode", this),
                            Ne(this.storedValue, "toJSON", he)
                    }
                }),
                ...
                Object.defineProperty(n.prototype, "_internalEventsRegister", {
                    ...
                    value: function (e, t, r) {
                        return (
                            void 0 === r && (r = !1),
                            this._internalEvents || (this._internalEvents = new xe()),
        ...
        N = (function () {
            ...
            return (
                Object.defineProperty(e.prototype, "create", {
                    ...
                    writable: !0,
                    value: function (e, t) {
                        return ie(this, e), this.instantiate(null, "", t, e).value
                    }
                }),
    ...
    var D = (function (e) {
        ...
        return (
            ...
            Object.defineProperty(t.prototype, "isMatchingSnapshotId", {
                ...
                writable: !0,
                value: function (e, t) {
                    return !e.identifierAttribute || e.identifier === Ut(t[e.identifierAttribute])
                }
            }),
            ...
            Object.defineProperty(t.prototype, "reconcile", {
                ...
                value: function (e, t, r, n) {
                    ...
                    if ((e.die(), pe(t) && this.isAssignableFrom(b(t)))) {
                        var i = fe(t)
        ...
        t.runInAction(function () {
            Te(r).forEach(function (t) {
                return (function (e, t) {
                    ...
                    var n = fe(r)
                    if ("@APPLY_PATCHES" === t.name) return d.call(null, r, t.args[0])
                    if ("@APPLY_SNAPSHOT" === t.name) return y.call(null, r, t.args[0])
                    if ("function" != typeof r[t.name])
                        throw _e("Action '" + t.name + "' does not exist in '" + n.path + "'")
                        ...
                        o = {
                            ...
                            args: n.args.map(function (e, t) {
                                return (function (e, t, r, n) {
                                    ...
                                    if (Ve(n)) return n
                                    if (pe(n)) return M("[MSTNode: " + b(n).name + "]")
                                    if ("function" == typeof n) return M("[function]")
                                    if ("object" == typeof n && !Ce(n) && !Ie(n))
                                        return M(
                                            "[object " +
    ...
    function Z(e, t, r) {
        return void 0 === r && (r = !0), fe(e).addMiddleWare(t, r)
    }
    var B = (function () {
        function e(e, t) {
    ...
    function X(e) {
        var t = e.value,
            ...
            a = pe(t) ? "value of type " + fe(t).type.name + ":" : Ve(t) ? "value" : "snapshot",
            o = r && pe(t) && r.is(fe(t).snapshot)
        return (
            "" +
            i +
            a +
                ...
                Object.defineProperty(e.prototype, "addNodeToCache", {
                    ...
                    value: function (e, r) {
                        if ((void 0 === r && (r = !0), e.identifierAttribute)) {
                            var n = e.identifier
                            this.cache.has(n) || this.cache.set(n, t.observable.array([], je))
                            var i = this.cache.get(n)
                            if (-1 !== i.indexOf(e)) throw _e("Already registered")
    ...
    function fe(e) {
        if (!pe(e)) throw _e("Value " + e + " is no MST Node")
        return e.$treenode
    }
    function be(e) {
    ...
    function ye(e, t) {
        ...
        for (var r = Ge(e.path), n = Ge(t.path), i = 0; i < r.length && r[i] === n[i]; i++);
        return r.slice(i).map(de).join("/") + We(n.slice(i))
    }
    function ve(e, t, r) {
        return void 0 === r && (r = !0), ge(e, Ge(t), r)
    }
    function ge(e, t, r) {
        void 0 === r && (r = !0)
    ...
    var we = Object.toString(),
        Pe = Object.freeze([]),
        Oe = Object.freeze({}),
        je = t._getGlobalState().useProxies ? { deep: !1 } : { deep: !1, proxy: !1 }
    function _e(e) {
    ...
    function Ce(e) {
        ...
        return (
            null == r ||
            (null === (t = r.constructor) || void 0 === t ? void 0 : t.toString()) === we
        )
    }
    function Ee(e) {
            ...
            return (
                ...
                Object.defineProperty(e.prototype, "register", {
                    ...
                    value: function (e, t, r) {
                        ...
                        return n || (n = this.eventHandlers[e] = new De()), n.register(t, r)
                    }
                }),
                Object.defineProperty(e.prototype, "has", {
                    enumerable: !1,
    ...
    function Fe(e) {
        return (function (e, t) {
            var r = function () {
                ...
                var a = W(),
                    o = $()
                if (!o) throw _e("a mst flow must always have a parent context")
                var u = Y(o)
                if (!u) throw _e("a mst flow must always have a parent action context")
                var s,
                    c,
                    p,
                    b = {
                        ...
                        context: o.context,
                        parentId: o.id,
                        allParentIds: f(o.allParentIds, [o.id]),
                        rootId: o.rootId,
                        parentEvent: o,
                        parentActionEvent: u
                    },
                ...
                function g(e) {
                    if (!e.done) {
                        if (!e.value || "function" != typeof e.value.then)
                            throw _e("Only promises can be yielded to `async`, got: " + e)
                ...
                var m = new Promise(function (e, i) {
                    ...
                    ;(a.$mst_middleware = r.$mst_middleware),
                        G(l(l({}, b), { type: "flow_spawn", args: ke(h) }), a)
                })
                return (
                    (m.cancel = function () {
    ...
    function We(e) {
        ...
        var t = function (e) {
            return e.map(Ue).join("/")
        }
        return "." === e[0] || ".." === e[0] ? t(e) : "/" + t(e)
    }
    function Ge(e) {
        var t = e.split("/").map($e)
        if (!("" === e || "." === e || ".." === e || Re(e, "/") || Re(e, "./") || Re(e, "../")))
            throw _e("a json path must be either rooted, empty or relative, but got '" + e + "'")
        return "" === t[0] && t.shift(), t
    }
    ze.ids = {}
    var Ye = Symbol("$preProcessorFailed"),
        Je = (function (e) {
            function t(t, r, n) {
            ...
            return (
                ...
                Object.defineProperty(t.prototype, "instantiate", {
                    ...
                    writable: !0,
                    value: function (e, t, r, n) {
                        var i = pe(n) ? n : this.preProcessSnapshot(n),
                ...
                Object.defineProperty(t.prototype, "reconcile", {
                    ...
                    value: function (e, t, r, n) {
                        var i = this._subtype.reconcile(
                            e,
                            pe(t) ? t : this.preProcessSnapshot(t),
                            r,
                            n
                        )
                ...
                Object.defineProperty(t.prototype, "isMatchingSnapshotId", {
                    ...
                    value: function (e, t) {
                        ...
                        return D.prototype.isMatchingSnapshotId.call(this._subtype, e, r)
                    }
                }),
                t
            )
    ...
    var Ke = (function (e) {
            ...
            return (
                ...
                Object.defineProperty(r.prototype, "put", {
                    ...
                    writable: !0,
                    value: function (e) {
                        if (!e) throw _e("Map.put cannot be used to set empty values")
                        if (pe(e)) {
                            var t = fe(e)
                            if (null === t.identifier) throw _e(Be)
                            return this.set(t.identifier, e), e
                        }
                        if (Ee(e)) {
                            var r = fe(this),
                                n = r.type
                            if (n.identifierMode !== Ze.YES) throw _e(Be)
                        ...
                        throw _e("Map.put can only be used to store complex values")
                    }
                }),
                r
            )
        ...
        qe = (function (e) {
            ...
            return (
                ...
                Object.defineProperty(r.prototype, "instantiate", {
                    ...
                    writable: !0,
                    value: function (e, t, r, n) {
                        return this._determineIdentifierMode(), se(this, e, t, r, n)
                    }
                }),
                Object.defineProperty(r.prototype, "_determineIdentifierMode", {
                    ...
                    writable: !0,
                    value: function () {
                        if (this.identifierMode === Ze.UNKNOWN) {
                            var e = []
                            if (
                                (function e(t, r) {
                                    var n,
                                    ...
                                    return t instanceof at && r.push(t), !0
                                })(this._subType, e)
                            ) {
                                var t = void 0
                                e.forEach(function (e) {
                                    ...
                                    t
                                        ? ((this.identifierMode = Ze.YES),
                                          (this.mapIdentifierAttribute = t))
                                        : (this.identifierMode = Ze.NO)
                            }
                        }
                    }
                }),
                ...
                Object.defineProperty(r.prototype, "processIdentifier", {
                    ...
                    writable: !0,
                    value: function (e, t) {
                        if (this.identifierMode === Ze.YES && t instanceof E) {
                            var r = t.identifier
                            if (r !== e)
                                throw _e(
                        ...
                        switch (e.type) {
                            ...
                            case "delete":
                                ...
                                return (
                                    e.oldValue.die(),
                                    void t.emitPatch(
                                        { op: "remove", path: Ue(e.name), oldValue: r },
                                        t
                                    )
                                )
                        }
    ...
    var Qe = (function (e) {
        ...
        return (
            ...
            Object.defineProperty(r.prototype, "createNewInstance", {
                ...
                writable: !0,
                value: function (e) {
                    return t.observable.array(me(e), je)
                }
            }),
            Object.defineProperty(r.prototype, "finalizeNewInstance", {
                enumerable: !1,
                ...
                value: function (e) {
                    ...
                    switch (e.type) {
                        case "update":
                            ...
                            var i = Xe(t, r, [n[e.index]], [e.newValue], [e.index])
                            if (!i) return null
                            e.newValue = i[0]
                            break
                        case "splice":
            ...
            Object.defineProperty(r.prototype, "applySnapshot", {
                ...
                writable: !0,
                value: function (e, t) {
                    ie(this, t), e.storedValue.replace(t)
                }
            }),
            Object.defineProperty(r.prototype, "getChildType", {
                enumerable: !1,
    ...
    function et(e, t, r, n, i) {
        ...
        var a = (function () {
            if (pe(n)) {
                var a = fe(n)
                if ((a.assertAlive(Oe), null !== a.parent && a.parent === t))
    ...
    var nt = { name: "AnonymousModel", properties: {}, initializers: Pe }
    function it(e) {
        return Object.keys(e).reduce(function (e, t) {
            ...
            if ("get" in o)
                throw _e("Getters are not supported as properties. Please use views instead")
            var u = o.value
            if (null == u)
                throw _e(
                        ...
                        (function (e) {
                            switch (typeof e) {
                                ...
                                case "boolean":
                                    return pt
                                case "object":
                                    if (e instanceof Date) return dt
                            }
                            throw _e("Cannot determine primitive type from value " + e)
                        })(u),
                        u
                    )),
                    n)
                )
            if (u instanceof qe) return Object.assign({}, e, (((i = {})[t] = jt(u, {})), i))
            if (u instanceof Qe) return Object.assign({}, e, (((a = {})[t] = jt(u, [])), a))
            if (k(u)) return e
            throw _e(
    ...
    var at = (function (e) {
        function n(t) {
            var r = e.call(this, t.name || nt.name) || this
            return (
                ...
                Object.assign(r, nt, t),
                (r.properties = it(r.properties)),
                r.properties,
        ...
        return (
            ...
            Object.defineProperty(n.prototype, "instantiateViews", {
                ...
                value: function (e, r) {
                    if (!Ce(r))
                        throw _e("views initializer should return a plain object containing views")
            ...
            Object.defineProperty(n.prototype, "instantiate", {
                ...
                writable: !0,
                value: function (e, t, r, n) {
                    return se(this, e, t, r, pe(n) ? n : this.applySnapshotPreProcessor(n))
                }
            }),
            ...
            Object.defineProperty(n.prototype, "createNewInstance", {
                ...
                writable: !0,
                value: function (e) {
                    return t.observable.object(e, Oe, je)
                }
            }),
            ...
            Object.defineProperty(n.prototype, "getChildNode", {
                ...
                writable: !0,
                value: function (e, r) {
                    if (!(r in this.properties)) throw _e("Not a value property: " + r)
                    var n = t._getAdministration(e.storedValue, r).raw()
                    if (!n) throw _e("Node not available for property " + r)
                    return n
                }
            }),
            Object.defineProperty(n.prototype, "getSnapshot", {
            ...
            Object.defineProperty(n.prototype, "applyPatchLocally", {
                ...
                value: function (e, t, r) {
                    if ("replace" !== r.op && "add" !== r.op)
                        throw _e("object does not support operation " + r.op)
    ...
    at.prototype.applySnapshot = t.action(at.prototype.applySnapshot)
    var ut = (function (e) {
            function t(t, r, n, i) {
                void 0 === i && (i = Se)
        ...
        lt = new ut("string", I.String, function (e) {
            return "string" == typeof e
        }),
        st = new ut("number", I.Number, function (e) {
            return "number" == typeof e
        }),
        ct = new ut("integer", I.Integer, function (e) {
            return Ae(e)
        }),
        pt = new ut("boolean", I.Boolean, function (e) {
            return "boolean" == typeof e
        }),
        ft = new ut("null", I.Null, function (e) {
            return null === e
        }),
        bt = new ut("undefined", I.Undefined, function (e) {
            return void 0 === e
        }),
        ht = new ut(
            "Date",
        ...
        return (
            ...
            Object.defineProperty(t.prototype, "instantiate", {
                ...
                value: function (e, t, r, n) {
                    ...
                    if (!i) throw _e("No matching type for union " + this.describe())
                ...
                value: function () {
                    var e =
                        "function" == typeof this._defaultValue
                            ? this._defaultValue()
                            : this._defaultValue
                    return "function" == typeof this._defaultValue && ie(this, e), e
                }
            }),
            Object.defineProperty(t.prototype, "isValidSnapshot", {
                enumerable: !1,
            ...
            function e(e, t) {
                if (
                    ...
                    if (!r.identifierAttribute)
                        throw _e("Can only store references with a defined identifier attribute.")
                                ...
                                this.onInvalidated({
                                    ...
                                    removeRef: function () {
                                        ot(i.type)
                                            ...
                                            : d(t.root.storedValue, { op: "remove", path: t.path })
                                    }
                                })
                        }
                    }
                            ...
                            var o = function (r) {
                                ...
                                if (o && o.isAlive && u) {
                                    ;(
                                        n
                                            ? !!n.get(t, u)
                                            : e.root.identifierCache.has(i.targetType, Ut(t))
                                    )
        ...
        kt = (function (e) {
            ...
            return (
                ...
                Object.defineProperty(t.prototype, "instantiate", {
                    ...
                    writable: !0,
                    value: function (e, t, r, n) {
                        var i = pe(n) ? this.options.set(n, e ? e.storedValue : null) : n,
                            a = ce(this, e, t, r, i)
                ...
                Object.defineProperty(t.prototype, "reconcile", {
                    ...
                    writable: !0,
                    value: function (e, t, r, n) {
                        var i = pe(t) ? this.options.set(t, e ? e.storedValue : null) : t
    ...
    function Rt(e, t) {
        ...
        return r && (r.get || r.set) ? new kt(e, { get: r.get, set: r.set }, n) : new xt(e, n)
    }
    var zt = (function (e) {
            function t(t, r) {
                var n = e.call(this, t) || this
        ...
        Gt = {
            ...
            model: function () {
                ...
                var r = "string" == typeof e[0] ? e.shift() : "AnonymousModel",
                    n = e.shift() || {}
                return new at({ name: r, properties: n })
            },
            compose: function () {
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t]
            ...
            safeReference: function (e, t) {
                ...
                return t && !1 === t.acceptsUndefined ? r : It(r)
            },
            union: Pt,
            optional: jt,
            literal: gt,
            ...
            Date: dt,
            map: function (e) {
                return new qe("map<string, " + e.name + ">", e)
            },
            array: function (e) {
                return new Qe(e.name + "[]", e)
            },
            frozen: function (e) {
                return 0 === arguments.length ? Et : k(e) ? new Ct(e) : jt(Et, e)
            },
            identifier: Ht,
            identifierNumber: Lt,
            late: function (e, t) {
                var r = "string" == typeof e ? e : "late(" + e.toString() + ")"
                return new Tt(r, "string" == typeof e ? t : e)
            },
            undefined: bt,
            null: ft,
    ...
    ;(e.addDisposer = function (e, t) {
        ...
        (e.detach = function (e) {
            return fe(e).detach(), e
        }),
        (e.escapeJsonPath = Ue),
        (e.flow = Fe),
        (e.getChildType = function (e, t) {
            return fe(e).getChildType(t)
        }),
        (e.getEnv = function (e) {
            var t = fe(e).root.environment
            return t || Oe
        }),
        (e.getIdentifier = w),
        ...
        (e.getParent = function (e, t) {
            void 0 === t && (t = 1)
            for (var r = t, n = fe(e).parent; n; ) {
                if (0 == --r) return n.storedValue
                n = n.parent
            }
            throw _e("Failed to find the parent of " + fe(e) + " at depth " + t)
        }),
        (e.getParentOfType = function (e, t) {
            for (var r = fe(e).parent; r; ) {
                if (t.is(r.storedValue)) return r.storedValue
                r = r.parent
            }
            throw _e("Failed to find the parent of " + fe(e) + " of a given type")
        }),
        (e.getPath = m),
        ...
        (e.isPrimitiveType = yt),
        (e.isProtected = function (e) {
            return fe(e).isProtected
        }),
        ...
        (e.isValidReference = function (e, t) {
            ...
            try {
                var r = e()
                if (null == r) return !1
                if (pe(r)) return !t || O(r)
                throw _e("The reference to be checked is not one of node, null or undefined")
            } catch (e) {
        ...
        (e.protect = function (e) {
            var t = fe(e)
            if (!t.isRoot) throw _e("`protect` can only be invoked on root nodes")
        ...
        (e.recordPatches = function (e, t) {
            var r,
                ...
                a = {
                    ...
                    undo: function (t) {
                        d(t || e, n.reversedInversePatches)
                    }
                }
            return a.resume(), a
        }),
        (e.resolveIdentifier = function (e, t, r) {
            var n = fe(t).root.identifierCache.resolve(e, Ut(r))
        ...
        (e.tryReference = function (e, t) {
            ...
            try {
                var r = e()
                if (null == r) return
                if (pe(r)) return t ? (O(r) ? r : void 0) : r
                throw _e("The reference to be checked is not one of node, null or undefined")
            } catch (e) {
        ...
        (e.typecheck = ae),
        (e.types = Gt),
        (e.unescapeJsonPath = $e),
        (e.unprotect = function (e) {
            var t = fe(e)
            if (!t.isRoot) throw _e("`unprotect` can only be invoked on root nodes")
            t.isProtectionEnabled = !1
        }),
        (e.walk = function e(t, r) {
            var n = fe(t)
            n.getChildren().forEach(function (t) {
                pe(t.storedValue) && e(t.storedValue, r)
            }),
                r(n.storedValue)
        }),
